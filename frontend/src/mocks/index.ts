...
export const mockVehicles: Vehicle[] = [
  { _id: "v1", registrationNumber: "V-8942", make: "Tata", model: "Prima", year: 2022, type: "truck", status: "active", odometer: 84500, fuelType: "diesel", fuelLevel: 72, healthScore: 94, assignedDriver: mockDrivers[0], location: { label: "Sector 7G, Industrial Park", x: 47, y: 42 }, speedKmph: 62 },
  { _id: "v2", registrationNumber: "V-4092", make: "Ashok Leyland", model: "Boss", year: 2021, type: "truck", status: "flagged", odometer: 132000, fuelType: "diesel", fuelLevel: 20, healthScore: 58, assignedDriver: mockDrivers[1], location: { label: "Highway 405, Mile 12", x: 38, y: 22 }, speedKmph: 0 },
  { _id: "v3", registrationNumber: "V-1105", make: "Eicher", model: "Pro 2049", year: 2023, type: "van", status: "in_maintenance", odometer: 41000, fuelType: "diesel", fuelLevel: 90, healthScore: 76, assignedDriver: mockDrivers[2], location: { label: "Central Hub Dock 4", x: 55, y: 55 }, speedKmph: 0 },
  { _id: "v4", registrationNumber: "V-2280", make: "BharatBenz", model: "1617R", year: 2020, type: "truck", status: "idle", odometer: 98000, fuelType: "diesel", fuelLevel: 55, healthScore: 82, assignedDriver: mockDrivers[3], location: { label: "Depot A", x: 33, y: 60 }, speedKmph: 0 },
  { _id: "v5", registrationNumber: "V-3391", make: "Tata", model: "Signa", year: 2022, type: "truck", status: "active", odometer: 65200, fuelType: "diesel", fuelLevel: 64, healthScore: 88, assignedDriver: mockDrivers[6], location: { label: "Baroda Bypass", x: 41, y: 47 }, speedKmph: 71 },
  { _id: "v6", registrationNumber: "V-7710", make: "Mahindra", model: "Blazo", year: 2021, type: "truck", status: "active", odometer: 71800, fuelType: "diesel", fuelLevel: 48, healthScore: 90, assignedDriver: mockDrivers[7], location: { label: "NH48, Nashik Stretch", x: 36, y: 65 }, speedKmph: 58 },
  { _id: "v7", registrationNumber: "V-5528", make: "Volvo", model: "FMX", year: 2023, type: "truck", status: "idle", odometer: 22300, fuelType: "diesel", fuelLevel: 81, healthScore: 96, location: { label: "Chennai Yard", x: 58, y: 78 }, speedKmph: 0 },
  { _id: "v8", registrationNumber: "V-9034", make: "Eicher", model: "Skyline", year: 2020, type: "bus", status: "active", odometer: 154000, fuelType: "diesel", fuelLevel: 39, healthScore: 71, location: { label: "Kolkata Ring Road", x: 74, y: 43 }, speedKmph: 44 },
  { _id: "v9", registrationNumber: "V-6647", make: "Tata", model: "Ace", year: 2023, type: "van", status: "active", odometer: 18900, fuelType: "electric", fuelLevel: 92, healthScore: 98, location: { label: "Bengaluru Hub", x: 52, y: 74 }, speedKmph: 35 },
  { _id: "v10", registrationNumber: "V-2201", make: "Ashok Leyland", model: "Dost", year: 2019, type: "van", status: "flagged", odometer: 141200, fuelType: "diesel", fuelLevel: 12, healthScore: 44, location: { label: "Lucknow Depot", x: 57, y: 32 }, speedKmph: 0 },
  { _id: "v11", registrationNumber: "V-8813", make: "BharatBenz", model: "914R", year: 2022, type: "truck", status: "active", odometer: 53400, fuelType: "diesel", fuelLevel: 58, healthScore: 85, location: { label: "Kanpur Ring Road", x: 55, y: 38 }, speedKmph: 66 },
  { _id: "v12", registrationNumber: "V-4470", make: "Tata", model: "Winger", year: 2021, type: "van", status: "idle", odometer: 39800, fuelType: "diesel", fuelLevel: 70, healthScore: 79, location: { label: "Hyderabad Depot", x: 55, y: 62 }, speedKmph: 0 },
  { _id: "v13", registrationNumber: "V-1987", make: "Eicher", model: "Pro 3015", year: 2020, type: "truck", status: "in_maintenance", odometer: 112000, fuelType: "diesel", fuelLevel: 33, healthScore: 62, location: { label: "Indore Service Center", x: 46, y: 52 }, speedKmph: 0 },
  { _id: "v14", registrationNumber: "V-6602", make: "Ashok Leyland", model: "Partner", year: 2023, type: "truck", status: "active", odometer: 9100, fuelType: "cng", fuelLevel: 66, healthScore: 99, location: { label: "Jaipur Bypass", x: 45, y: 30 }, speedKmph: 54 },
];
