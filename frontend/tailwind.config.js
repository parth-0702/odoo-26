...
export default {
  ...
  theme: {
    extend: {
      ...
      borderWidth: { 3: "3px" },
      boxShadow: {
        pop: "0 8px 30px rgba(0, 0, 0, 0.05)",
        "pop-sm": "0 4px 12px rgba(0, 0, 0, 0.03)",
        "pop-lg": "0 16px 40px rgba(0, 0, 0, 0.08)",
        "pop-primary": "0 8px 24px rgba(181,18,27,0.12)",
        "pop-hover": "0 8px 24px rgba(0,0,0,0.08)",
        soft: "0 12px 32px rgba(43,43,47,0.04)",
        "soft-lg": "0 24px 60px rgba(43,43,47,0.08)",
      },
      colors: {
        background: "#F8F8F8",
        surface: "#FFFFFF",
